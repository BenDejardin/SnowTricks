 ...
 */
final class Version20230707133854 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // $this->addSql('ALTER TABLE tricks ADD created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
